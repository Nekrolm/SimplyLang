...
public enum Tokens {error=63,EOF=64,BEGIN=65,END=66,
    ...
    PRINT=79,FOR=80,IN=81,INUM=82,RNUM=83,ID=84};
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14},new int[]{-14,5,-8,80,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
    states[5] = new State(new int[]{66,6,69,7});
    states[6] = new State(-40);
    states[7] = new State(new int[]{65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14},new int[]{-8,8,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(-6);
    states[11] = new State(new int[]{68,12});
    states[12] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,13,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[13] = new State(new int[]{74,14,73,28,66,-16,69,-16,72,-16});
    states[14] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-6,15,-1,50,-3,37,-4,36,-2,22});
    states[15] = new State(new int[]{60,16,62,30,70,42,78,44,77,46,76,48,74,-19,73,-19,66,-19,69,-19,72,-19,41,-19,65,-19,84,-19,67,-19,71,-19,79,-19,80,-19,44,-19});
    states[16] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,17,-3,37,-4,36,-2,22});
    states[17] = new State(new int[]{43,18,45,32,60,-23,62,-23,70,-23,78,-23,77,-23,76,-23,74,-23,73,-23,66,-23,69,-23,72,-23,41,-23,65,-23,84,-23,67,-23,71,-23,79,-23,80,-23,44,-23});
    states[18] = new State(new int[]{84,23,82,24,40,25},new int[]{-3,19,-4,36,-2,22});
    states[19] = new State(new int[]{42,20,47,34,43,-32,45,-32,60,-32,62,-32,70,-32,78,-32,77,-32,76,-32,74,-32,73,-32,66,-32,69,-32,72,-32,41,-32,65,-32,84,-32,67,-32,71,-32,79,-32,80,-32,44,-32});
    ...
    states[25] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,26,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[26] = new State(new int[]{41,27,74,14,73,28});
    states[27] = new State(-39);
    states[28] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-6,29,-1,50,-3,37,-4,36,-2,22});
    states[29] = new State(new int[]{60,16,62,30,70,42,78,44,77,46,76,48,74,-20,73,-20,66,-20,69,-20,72,-20,41,-20,65,-20,84,-20,67,-20,71,-20,79,-20,80,-20,44,-20});
    states[30] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,31,-3,37,-4,36,-2,22});
    states[31] = new State(new int[]{43,18,45,32,60,-24,62,-24,70,-24,78,-24,77,-24,76,-24,74,-24,73,-24,66,-24,69,-24,72,-24,41,-24,65,-24,84,-24,67,-24,71,-24,79,-24,80,-24,44,-24});
    states[32] = new State(new int[]{84,23,82,24,40,25},new int[]{-3,33,-4,36,-2,22});
    states[33] = new State(new int[]{42,20,47,34,43,-33,45,-33,60,-33,62,-33,70,-33,78,-33,77,-33,76,-33,74,-33,73,-33,66,-33,69,-33,72,-33,41,-33,65,-33,84,-33,67,-33,71,-33,79,-33,80,-33,44,-33});
    states[34] = new State(new int[]{84,23,82,24,40,25},new int[]{-4,35,-2,22});
    states[35] = new State(-36);
    states[36] = new State(-34);
    states[37] = new State(new int[]{42,20,47,34,43,-29,45,-29,60,-29,62,-29,70,-29,78,-29,77,-29,76,-29,74,-29,73,-29,66,-29,69,-29,72,-29,41,-29,65,-29,84,-29,67,-29,71,-29,79,-29,80,-29,44,-29});
    states[38] = new State(new int[]{84,23,82,24,40,25},new int[]{-3,39,-4,36,-2,22});
    states[39] = new State(new int[]{42,20,47,34,43,-30,45,-30,60,-30,62,-30,70,-30,78,-30,77,-30,76,-30,74,-30,73,-30,66,-30,69,-30,72,-30,41,-30,65,-30,84,-30,67,-30,71,-30,79,-30,80,-30,44,-30});
    states[40] = new State(new int[]{84,23,82,24,40,25},new int[]{-3,41,-4,36,-2,22});
    states[41] = new State(new int[]{42,20,47,34,43,-31,45,-31,60,-31,62,-31,70,-31,78,-31,77,-31,76,-31,74,-31,73,-31,66,-31,69,-31,72,-31,41,-31,65,-31,84,-31,67,-31,71,-31,79,-31,80,-31,44,-31});
    states[42] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,43,-3,37,-4,36,-2,22});
    states[43] = new State(new int[]{43,18,45,32,60,-25,62,-25,70,-25,78,-25,77,-25,76,-25,74,-25,73,-25,66,-25,69,-25,72,-25,41,-25,65,-25,84,-25,67,-25,71,-25,79,-25,80,-25,44,-25});
    states[44] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,45,-3,37,-4,36,-2,22});
    states[45] = new State(new int[]{43,18,45,32,60,-26,62,-26,70,-26,78,-26,77,-26,76,-26,74,-26,73,-26,66,-26,69,-26,72,-26,41,-26,65,-26,84,-26,67,-26,71,-26,79,-26,80,-26,44,-26});
    states[46] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,47,-3,37,-4,36,-2,22});
    states[47] = new State(new int[]{43,18,45,32,60,-27,62,-27,70,-27,78,-27,77,-27,76,-27,74,-27,73,-27,66,-27,69,-27,72,-27,41,-27,65,-27,84,-27,67,-27,71,-27,79,-27,80,-27,44,-27});
    states[48] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-1,49,-3,37,-4,36,-2,22});
    states[49] = new State(new int[]{43,18,45,32,60,-28,62,-28,70,-28,78,-28,77,-28,76,-28,74,-28,73,-28,66,-28,69,-28,72,-28,41,-28,65,-28,84,-28,67,-28,71,-28,79,-28,80,-28,44,-28});
    states[50] = new State(new int[]{43,18,45,32,60,-22,62,-22,70,-22,78,-22,77,-22,76,-22,74,-22,73,-22,66,-22,69,-22,72,-22,41,-22,65,-22,84,-22,67,-22,71,-22,79,-22,80,-22,44,-22});
    states[51] = new State(new int[]{60,16,62,30,70,42,78,44,77,46,76,48,74,-17,73,-17,66,-17,69,-17,72,-17,41,-17,65,-17,84,-17,67,-17,71,-17,79,-17,80,-17,44,-17});
    states[52] = new State(new int[]{84,23,82,24,40,25,43,38,45,40},new int[]{-6,53,-1,50,-3,37,-4,36,-2,22});
    states[53] = new State(new int[]{60,16,62,30,70,42,78,44,77,46,76,48,74,-18,73,-18,66,-18,69,-18,72,-18,41,-18,65,-18,84,-18,67,-18,71,-18,79,-18,80,-18,44,-18});
    states[54] = new State(-7);
    states[55] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,56,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[56] = new State(new int[]{74,14,73,28,65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14,72,-14},new int[]{-8,57,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
    states[57] = new State(-41);
    states[58] = new State(-8);
    states[59] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,60,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[60] = new State(new int[]{74,14,73,28,65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14,72,-14},new int[]{-8,61,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
    states[61] = new State(new int[]{72,62,66,-12,69,-12});
    states[62] = new State(new int[]{65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14,72,-14},new int[]{-8,63,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
    states[63] = new State(-13);
    states[64] = new State(-9);
    states[65] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,66,-6,51,-1,50,-3,37,-4,36,-2,22});
    ...
    states[72] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,73,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[73] = new State(new int[]{44,74,74,14,73,28});
    states[74] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,75,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[75] = new State(new int[]{44,76,74,14,73,28});
    states[76] = new State(new int[]{84,23,82,24,40,25,43,38,45,40,75,52},new int[]{-5,77,-6,51,-1,50,-3,37,-4,36,-2,22});
    states[77] = new State(new int[]{41,78,74,14,73,28});
    states[78] = new State(new int[]{65,4,84,23,67,55,71,59,79,65,80,69,66,-14,69,-14,72,-14},new int[]{-8,79,-15,9,-7,10,-2,11,-9,54,-11,58,-12,64,-10,67,-13,68});
