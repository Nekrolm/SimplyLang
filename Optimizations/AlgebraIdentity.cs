...
namespace SimpleLang.Optimizations
{
    public class AlgebraIdentity : BaseBlockOptimization
    {
        ...
        private string ComputeBothVar(string OpType) // Метод в зависимости от операции выполняет вычисление и возвращает значение.
        {
            switch (OpType)
            {
                case ThreeAddrOpType.Minus: return "0";
                case ThreeAddrOpType.Less: return "0"; 
                case ThreeAddrOpType.Greater: return "0";
                case ThreeAddrOpType.LessOrEq: return "1";
                case ThreeAddrOpType.GreaterOrEq: return "1";
                case ThreeAddrOpType.Eq: return "1";
                case ThreeAddrOpType.UnEq: return "0";
                default:
                    return null;
            }
        }
